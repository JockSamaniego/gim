...
public class PropertyRegisterList extends EntityQuery<PropertyRegister> {
    ...
    private static final String[] RESTRICTIONS = {
            "(lower(propertyRegister.identificationNumber) like lower(concat(#{propertyRegisterList.resident},'%')) or " +
            "lower(propertyRegister.intervenerName) like lower(concat('%',:el1,'%')))",
