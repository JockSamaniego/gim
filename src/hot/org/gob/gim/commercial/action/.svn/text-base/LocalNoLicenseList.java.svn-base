...
@Name("localNoLicenseList")
public class LocalNoLicenseList extends EntityQuery<Local> {
	...
	private static final String EJBQL = "SELECT local from Local local WHERE "+
			"local.isActive = true AND (local.licenseyear = null OR local.licenseyear != '"+fiscalYear+"')";
