...
@Name("appraisalItemWallList")
public class AppraisalItemWallList extends EntityQuery<AppraisalItemWall> {

	private static final long serialVersionUID = 1L;

	private static final String EJBQL = "select aIWall from AppraisalItemWall aIWall";
