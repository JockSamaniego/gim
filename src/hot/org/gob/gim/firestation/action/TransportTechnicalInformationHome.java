...
@Name("transportTechnicalInformationHome")
public class TransportTechnicalInformationHome extends
		EntityHome<TransportTechnicalInformation> {
	...
	public void setTransportTechnicalInformationId(Long id) {
		setId(id);
	}

	public Long getTransportTechnicalInformationId() {
		return (Long) getId();
	}
	...
	public void wire() {
		if (!isFirstTime)
			return;
		// if(getInstance() != null && getInstance().getFireMan() != null)
		// setFireManIdentificationNumber(getInstance().getFireMan().getIdentificationNumber());
		// getInstance();
		isFirstTime = false;
	}
	...
	public TransportTechnicalInformation getDefinedInstance() {
	...
	public void searchResident() {
		logger.info("looking for............holaaaaaa {0}",
				getOwnerIdentificationNumber());
	...
	public void addObservation() {
		this.getInstance().add(new InspectionObservation());
	}
