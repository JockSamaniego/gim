...
public class WorkdayHomeWs extends EntityHome<Workday> {
    ...
    @In(create = true)
    TillPermissionHomeWs tillPermissionHomeWsf;
    ...
    //@Observer("org.jboss.seam.postCreate.workdayHomeWs")
    public void checkSettings() {
        System.out.println("CHECKING SETTINGS FOR SCREEN ...");
        Date date = DateUtils.truncate(new Date());
        Query query = getPersistenceContext().createNamedQuery("InterestRate.findActive");
    ...
    private boolean existsTaxRates() {
        Query query = getPersistenceContext().createNamedQuery("Tax.findByEntryNotNull");
    ...
    private BigDecimal sumTotalCashCollected() {
        ...
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getMunicipalBondsNumber() != null) {
                totalBondsCollected = totalBondsCollected + e.getMunicipalBondsNumber();
            }
            if (e.getIsDiscount() && e.getTotal() != null) {
                totalCashCollectedPreviousYears = totalCashCollectedPreviousYears.subtract(e.getPreviousYears() == null ? BigDecimal.ZERO : e.getPreviousYears());
                totalCashCollectedCurrentYear = totalCashCollectedCurrentYear.subtract(e.getValue() == null ? BigDecimal.ZERO : e.getValue());
                total = total.subtract(e.getTotal());
            }
            if (!e.getIsDiscount() && e.getTotal() != null) {
                totalCashCollectedPreviousYears = totalCashCollectedPreviousYears.add(e.getPreviousYears() == null ? BigDecimal.ZERO : e.getPreviousYears());
                totalCashCollectedCurrentYear = totalCashCollectedCurrentYear.add(e.getValue() == null ? BigDecimal.ZERO : e.getValue());
    ...
    private BigDecimal totalDiscountCompensationCollected() {
        ...
        for (EntryTotalCollected e : entryTotalDiscountByCompensation) {
            if (e.getTotal() != null) {
                discountsValueByCompensation = discountsValueByCompensation.add(e.getTotal());
            }
            if (e.getValue() != null) {
                currentDiscountsValueCompensation = currentDiscountsValueCompensation.add(e.getValue());
            }
            if (e.getPreviousYears() != null) {
                previousDiscountsValueCompensation = previousDiscountsValueCompensation.add(e.getPreviousYears());
            }
        }
    ...
    private BigDecimal totalDiscountCashCollected() {
        ...
        for (EntryTotalCollected e : entryTotalDiscount) {
            if (e.getTotal() != null) {
                discountsValueEffective = discountsValueEffective.add(e.getTotal());
            }
            if (e.getValue() != null) {
                currentDiscountsValueEffective = currentDiscountsValueEffective.add(e.getValue());
            }
            if (e.getPreviousYears() != null) {
                previousDiscountsValueEffective = previousDiscountsValueEffective.add(e.getPreviousYears());
            }
        }
    ...
    private BigDecimal totalCompensationGenerate() {
        ...
        for (EntryTotalCollected e : entryTotalCollectedsByCompensation) {
            if (e.getIsDiscount() && e.getTotal() != null) {
                totalValueByCompensation = totalValueByCompensation.subtract(e.getTotal());
            }

            if (!e.getIsDiscount() && e.getTotal() != null) {
                totalValueByCompensation = totalValueByCompensation.add(e.getTotal());
            }
    ...
    public BigDecimal totalInAgreement() {
        ...
        for (EntryTotalCollected e : entryTotalCollectedsInAgreement) {
            ...
            if (e.getPreviousYears() != null) {
                previousValueAgreement = previousValueAgreement.add(e.getPreviousYears());
            }
            if (e.getValue() != null) {
                currentValueAgreement = currentValueAgreement.add(e.getValue());
            }
            if (e.getInterest() != null) {
                interestValueAgreement = interestValueAgreement.add(e.getInterest());
            }
            if (e.getTaxes() != null) {
    ...
    private void sumTotalNullified() {
        ...
        for (ReportView t : totalEmitteds) {
            if (t.getTotalValueReversed() != null) {
                totalNullifieds = totalNullifieds.add(t.getTotalValueReversed());
            }
        }
    }
    ...
    private void sumTotalMunicipalBondEmitted() {
        ...
        for (ReportView t : totalEmitteds) {
            totalMunicipalBondEmitted = totalMunicipalBondEmitted + t.getTotalCorrect();
        }
    }
    ...
    private void sumTotalMunicipalBondNullified() {
        ...
        for (ReportView t : totalNullified) {
            totalMunicipalBondNullified = totalMunicipalBondNullified + t.getTotalCorrect();
        }
    }
    ...
    public void findDetailedDepositsByCashier() {
        municipalBondViews = getMunicipalBondsViewBetweenDatesByCashier(person.getId());
    ...
    @SuppressWarnings("unchecked")
    private List<MunicipalBondView> getMunicipalBondsViewBetweenDatesByCashier(Long cashierId) {
    ...
    public int servedPeople() {
        ...
        Query query = getEntityManager().createNamedQuery("Payment.findNumberBetweenDates");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
    ...
    private Long transactionsNumber() {
        ...
        Query query = getEntityManager().createNamedQuery("Payment.depositsNumber");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
    ...
    public void liquidateMunicipalBondsInCompensation() {
        ...
        Query query = getEntityManager().createNamedQuery("MunicipalBond.changeStatus");
        if (systemParameterService == null) {
            systemParameterService = ServiceLocator.getInstance().findResource(SYSTEM_PARAMETER_SERVICE_NAME);
        }
        Long municipalBondStatusId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_PAID");
    ...
    private List<Payment> getPaymentsBetweenDates() {
        Query query = getEntityManager().createNamedQuery("Payment.BetweenDates");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        return query.getResultList();
    }

    public Long getNumberOfTillOpened(Long workdayId) {
        Query query = getEntityManager().createNamedQuery("TillPermission.findNumberOpenTillsByWorkday");
    ...
    private List<Entry> getEntriesFromMunicipalBondsBetweenDates() {
        ...
        if (municipalBondStatus == null) {
            query = getEntityManager().createNamedQuery("MunicipalBond.findEntriesBetweenEmissionDates");
            query.setParameter("statusId", statusIds);
        } else {
            query = getEntityManager().createNamedQuery("MunicipalBond.findEntriesBetweenEmissionDatesAndMunicipalBondStatus");
    ...
    @SuppressWarnings("unchecked")
    private List<MunicipalBondView> getMunicipalBondsViewBetweenDatesByEntry(Entry e) {
        String namedQuery = "";
        if (municipalBondStatus == null) {
    ...
    private List<Account> getTaxesAccountsFromMunicipalBondsBetweenDates() {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.findATaxAccountsBetweenEmissionDatesByItem");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        return query.getResultList();
    }
    ...
    private List<Account> getAccountsFromMunicipalBondsBetweenDates() {
        Query query = null;
        if (entry != null) {
            query = getEntityManager().createNamedQuery("MunicipalBond.findAccountBetweenEmissionDatesByEntryByItem");
    ...
    private void generateCompleteReportByItems() {
        ...
        entryTotalCollectedsByCompensation = getTotalCompensationCollectedByItem(startDate, endDate);
        ...
        for (int i = 0; i < list.size(); i++) {
            for (int j = i + 1; j < list.size(); j++) {
                if (list.get(i).getGroupBy().equals(list.get(j).getGroupBy())) {
                    list.get(i).setValue(list.get(i).getValue().add(list.get(j).getValue()));
                    ...
                    list.get(i).setPreviousYears(list.get(i).getPreviousYears().add(list.get(j).getPreviousYears()));
                    list.get(i).setTotal(list.get(i).getTotal().add(list.get(j).getTotal()));
                    list.remove(j);
                    if (j > 0) {
                        j = j - 1;
                    }
     ...
     */
    private List<EntryTotalCollected> getTotalCompensationCollectedByItem(Date startDate, Date endDate) {
        ...
        result.addAll(getAllInterestByItem(statuses, interestAccountEmaalep, "EMAALEP"));
    ...
    private List<EntryTotalCollected> getAllTotalsByItem(List<Long> statusIds) {
        List<EntryTotalCollected> currentPeriod = getTotalsByItems(startDate, endDate, statusIds, false);
        List<EntryTotalCollected> previousPeriod = getTotalsByItems(startDate, endDate, statusIds, true);
    ...
    private List<EntryTotalCollected> getAllDiscountByItem(List<Long> statusIds) {
        List<EntryTotalCollected> currentPeriod = getTotalsDiscountByItems(startDate, endDate, statusIds, false);
        List<EntryTotalCollected> previousPeriod = getTotalsDiscountByItems(startDate, endDate, statusIds, true);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
     ...
     */
    @SuppressWarnings("unchecked")
    private List<EntryTotalCollected> getTotalsDiscountByItems(Date startDate, Date endDate, List<Long> municipalBondStatusIds, boolean isPreviousYears) {

        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(ac.id, ac.accountName," + groupBy + ", SUM(i.total)) "
        ...
        sql = sql + "AND pa is null)"
                + " GROUP BY ac.id, ac.accountName, " + groupBy + " ORDER BY " + groupBy;
    ...
    private List<EntryTotalCollected> getAllSurchargeByItem(List<Long> statusIds) {
        List<EntryTotalCollected> currentPeriod = getTotalsSurchargeByItems(startDate, endDate, statusIds, false);
        List<EntryTotalCollected> previousPeriod = getTotalsSurchargeByItems(startDate, endDate, statusIds, true);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
    ...
    private List<EntryTotalCollected> getAllTaxesByItem(List<Long> statusIds) {
        List<EntryTotalCollected> currentPeriod = getTotalsTaxByItems(startDate, endDate, statusIds, false);
        List<EntryTotalCollected> previousPeriod = getTotalsTaxByItems(startDate, endDate, statusIds, true);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
     ...
     */
    @SuppressWarnings("unchecked")
    private List<EntryTotalCollected> getTotalsTaxByItems(Date startDate, Date endDate, List<Long> municipalBondStatusIds, boolean isPreviousYears) {
        ...
        sql = sql + "AND m.municipalBondStatus.id in (:municipalBondStatusIds) "
                + "AND pa is null)"
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsByItem(Date startDate, Date endDate) {
        List<EntryTotalCollected> result;
        ...
        result.addAll(getAllInterestByItem(getPaidStatuses(), interestAccount, "GAD"));
        result.addAll(getAllInterestByItem(getPaidStatuses(), interestAccountEmaalep, "EMAALEP"));
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getAllInterestByItem(List<Long> statusId, Account account, String institution) {
        List<EntryTotalCollected> currentPeriod = getTotalsInterestByItems(startDate, endDate, statusId, false, account, institution);
        List<EntryTotalCollected> previousPeriod = getTotalsInterestByItems(startDate, endDate, statusId, true, account, institution);
     ...
     */
    @SuppressWarnings("unchecked")
    private List<EntryTotalCollected> getTotalsInterestByItems(Date startDate, Date endDate, List<Long> municipalBondStatusIds, boolean isPreviousYears, Account account, String institution) {
...
//		}
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsSurchargeByItems(Date startDate, Date endDate, List<Long> municipalBondStatusIds, boolean isPreviousYears) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsByItems(Date startDate, Date endDate, List<Long> municipalBondStatusIds, boolean isPreviousYears) {
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(ac.id, ac.accountName," + groupBy + ", SUM(i.total)) "
                + "from MunicipalBond m "
                + "join m.items i "
                + "join i.entry e left "
    ...
    private void generateCompleteReport() {
        ...
        if (isClosingWorkday) {
            Workday ins = getInstance();
            startDate = ins.getDate();
        }
        if (endDate == null) {
            endDate = startDate;
        }
    ...
    private void totalValuesCompensationCollectedByEntry() {
        ...
        for (EntryTotalCollected e : entryTotalCollectedsByCompensation) {
            if (e.getMunicipalBondsNumber() != null) {
                totalBondsCollectedByCompensation = totalBondsCollectedByCompensation + e.getMunicipalBondsNumber();
            }
            if (e.getDiscount() != null) {
                discountsValueByCompensation = discountsValueByCompensation.add(e.getDiscount());
            }

            if (e.getSurcharge() != null) {
                surchargesValueCompensation = surchargesValueCompensation.add(e.getSurcharge());
            }

            if (e.getInterest() != null) {
                interestValueCompensation = interestValueCompensation.add(e.getInterest());
            }

            if (e.getPreviousYears() != null) {
                previousValueCompensation = previousValueCompensation.add(e.getPreviousYears());
            }

            if (e.getValue() != null) {
                currentValueCompensation = currentValueCompensation.add(e.getValue());
            }

            if (e.getTaxes() != null) {
                taxesValueCompensation = taxesValueCompensation.add(e.getTaxes());
            }
        }
    ...
    private void totalValuesCashCollectedByEntry() {
        ...
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getDiscount() != null) {
                discountsValueEffective = discountsValueEffective.add(e.getDiscount());
            }

            if (e.getSurcharge() != null) {
                surchargesValueEffective = surchargesValueEffective.add(e.getSurcharge());
            }

            if (e.getInterest() != null) {
                interestValueEffective = interestValueEffective.add(e.getInterest());
            }
    ...
    private List<EntryTotalCollected> getAllTotalsCompensationCollectedByEntry() {
        List<EntryTotalCollected> currentPeriod = getTotalCompensationCollectedByEntryCurrentPeriod(startDate, endDate);
        List<EntryTotalCollected> previousPeriod = getTotalCompensationCollectedByEntryPreviousYears(startDate, endDate);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
    ...
    private List<EntryTotalCollected> getTotalCompensationCollectedByEntryPreviousYears(Date startDate, Date endDate) {
        if (groupBy == null) {
            groupBy = "e.code";
        }

        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id,count(m.id), e.name," + groupBy + ", SUM(m.value), SUM(m.discount), SUM(m.surcharge),"
    ...
    private List<EntryTotalCollected> getTotalCompensationCollectedByEntryCurrentPeriod(Date startDate, Date endDate) {
        if (groupBy == null) {
            groupBy = "e.code";
        }
    ...
    private List<EntryTotalCollected> getAllTotalsPaymentAgrement() {
        List<EntryTotalCollected> currentPeriod = getTotalInPaymentAgreementByEntryCurrentPeriod(startDate, endDate);
        List<EntryTotalCollected> previousPeriod = getTotalInPaymentAgreementByEntryPreviosuYears(startDate, endDate);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalInPaymentAgreementByEntryPreviosuYears(Date startDate, Date endDate) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalInPaymentAgreementByEntryCurrentPeriod(Date startDate, Date endDate) {
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id,count(d.id), e.name,e.code, SUM(d.capital), SUM(d.discount), SUM(d.surcharge), "
                + " SUM(d.interest), SUM(d.paidTaxes), SUM (d.value)) from MunicipalBond m "
                + "join m.deposits d "
                + "join m.paymentAgreement pa "
    ...
    private List<EntryTotalCollected> getAllTotalEffectiveCollectedByEntry() {
        List<EntryTotalCollected> currentPeriod = getTotalEffectiveCollectedByEntryCurrentPeriod(startDate, endDate);
        List<EntryTotalCollected> previousPeriod = getTotalEffectiveCollectedByEntryPreviousYears(startDate, endDate);
        List<EntryTotalCollected> missing = new ArrayList<EntryTotalCollected>();
        for (EntryTotalCollected et1 : previousPeriod) {
            boolean exist = false;
            for (EntryTotalCollected et : currentPeriod) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalEffectiveCollectedByEntryPreviousYears(Date startDate, Date endDate) {
        if (groupBy == null) {
            groupBy = "e.code";
        }
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalEffectiveCollectedByEntryCurrentPeriod(Date startDate, Date endDate) {
        if (groupBy == null) {
            groupBy = "e.code";
        }
    ...
    private void findAccountsForEmissionSummary() {
        ...
        accountsFromMunicipalBond.addAll(getTaxesAccountsFromMunicipalBondsBetweenDates());
    ...
    public void generateSummaryTree() {
        if (!globalReport && isFromIncome) {
            ...
            entryTotalCollectedsByCompensationForTree = getTotalCompensationCollectedByItem(startDate, endDate);
    ...
    public void generateGlobalReport() {
        ...
        if (isClosingWorkday) {
            ...
            if (globalReport) {
                ...
                groupBy = "e.code";
                generateCompleteReport();
				//HABILITAR para revisar errores en cuadres de cajas y reportes de recaudaciones o partidas
                //findMistakesInValuesByEntry(startDate, endDate, pendingStatus.getId(),76L);
    ...
    private void orderByGroupBy(List<EntryTotalCollected> list) {
        ...
        for (String s : groupBy) {
            for (EntryTotalCollected ac : list) {
                if (ac != null && ac.getGroupBy().equals(s) && !res.contains(ac)) {
                    res.add(ac);
                }
            }
        }
     ...
     */
    private List<MunicipalBond> findMunicipalBonds(Long statusId, boolean isPaymentAgreement) {
        String sql = "";
     ...
     * @param entryId
     */
    private void findMistakesInValuesByEntry(Date startDate, Date endDate, Long statusId, Long entryId) {
        List<Long> ids = new ArrayList<Long>();
        List<Long> paidTotalIds = new ArrayList<Long>();
        List<MunicipalBond> municipalBonds = findMunicipalBonds(statusId, entryId);
        ...
        if (paidTotalIds.size() > 0) {
            System.out.println("::::::::::::::::::::.statusId::::::::::::::" + statusId + ":::::::::::::::::::::::::::::::::::::mistake in sum of paidtotal :::::::::::::::::. " + paidTotalIds);
        }
        if (ids.size() > 0) {
            System.out.println("::::::::::::::::::::.statusId::::::::::::::" + statusId + ":::::::::::::::::::::::::::::::::::::mistake in total deposits :::::::::::::::::. " + ids);
        }
    }
     ...
     * @param ispaymentAgreement
     */
    private void findMistakesInValues(Date startDate, Date endDate, Long statusId, Boolean ispaymentAgreement) {
        List<Long> ids = new ArrayList<Long>();
        List<Long> ids1 = new ArrayList<Long>();
        List<Long> paidTotalIds = new ArrayList<Long>();
        List<MunicipalBond> municipalBonds = findMunicipalBonds(statusId, ispaymentAgreement);
        for (MunicipalBond mb : municipalBonds) {
            ids1.add(mb.getId());
            if (!isPaidTotalCorrect(mb)) {
                paidTotalIds.add(mb.getId());
        ...
        isMunicipalBondItemsTotalCorrect(municipalBonds, statusId, ispaymentAgreement);
        if (paidTotalIds.size() > 0) {
            System.out.println("::::::::::::::::::::.paid total statusId::::::::::::::" + statusId + ":::::::::::::::::::::::::::::::::::::mistake in sum of paidtotal :::::::::::::::::. " + paidTotalIds);
        }
        if (ids.size() > 0) {
            System.out.println("::::::::::::::::::::.deposits statusId::::::::::::::" + statusId + ":::::::::::::::::::::::::::::::::::::mistake in total deposits :::::::::::::::::. " + ids);
        }
    }
     ...
     * @param isPaymentAgreement
     */
    private void isMunicipalBondItemsTotalCorrect(List<MunicipalBond> municipalBonds, Long statusId, Boolean isPaymentAgreement) {
        List<Long> ids = new ArrayList<Long>();
        ...
        if (!isPaymentAgreement) {
            ...
            for (MunicipalBond mb : municipalBonds) {
                ...
                if (res.compareTo(mb.getPaidTotal()) != 0 && !statusId.equals(pendingStatus.getId())) {
                    System.out.println(":::::::::::::::::::::::::.id::::::::::::::::::::::::::::::: " + mb.getId());
                    System.out.println(":::::::::::::::::::::::::.suma es::::::::::::::::::::::::::::::: " + res);
                    System.out.println(":::::::::::::::::::::::::.paidtotal es::::::::::::::::::::::::::::::: " + mb.getPaidTotal());
                    System.out.println(":::::::::::::::::::::::::.value es::::::::::::::::::::::::::::::: " + mb.getValue());
                    System.out.println(":::::::::::::::::::::::::.emisiondate es::::::::::::::::::::::::::::::: " + mb.getEmisionDate());
                    ids.add(mb.getId());
                }

                if (res.compareTo(mb.getValue()) != 0 && statusId.equals(pendingStatus.getId())) {
                    System.out.println(":::::::::::::::::::::::::.id::::::::::::::::::::::::::::::: " + mb.getId());
                    System.out.println(":::::::::::::::::::::::::.suma es::::::::::::::::::::::::::::::: " + res);
                    System.out.println(":::::::::::::::::::::::::.paidtotal es::::::::::::::::::::::::::::::: " + mb.getPaidTotal());
                    System.out.println(":::::::::::::::::::::::::.difference es::::::::::::::::::::::::::::::: " + res.subtract(mb.getPaidTotal()));
                    ids.add(mb.getId());
                }
            }
        ...
        if (ids.size() > 0) {
            ...
            System.out.println("::::::::::::::::::::.statusId::::::::::::::" + statusId + " :::::::::::::::::::::::::::::::::::::mistake in items :::::::::::::::::. " + ids);
        }
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsInterestByItemsByMb(Long municipalBondStatusId) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsTaxByItemsByMb(Long municipalBondStatusId) {
        ...
        sql = sql + "left join m.paymentAgreement pa "
                + "where ";
        if (!municipalBondStatusId.equals(pendingStatus.getId())) {
            sql = sql + "d.date Between :startDate and :endDate AND ";
        } else {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsDiscountByItemsByMb(Long municipalBondStatusId) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsSurchargeByItemsByMb(Long municipalBondStatusId) {
     ...
     * @return List<EntryTotalCollected>
     */
    private List<EntryTotalCollected> getTotalsByItemsByMb(Long municipalBondStatusId) {
    ...
    private boolean isPaidTotalCorrect(MunicipalBond mb) {
        BigDecimal res = mb.getValue().add(mb.getSurcharge()).add(mb.getInterest()).add(mb.getTaxesTotal()).subtract(mb.getDiscount());
        if (res.compareTo(mb.getPaidTotal()) == 0) {
            return true;
        }
        return false;
    ...
    public void generateEmissionGlobalReport() {
        ...
        orderByGroupBy(entryTotalCollecteds);
        //log.info("-------------------------5.------------------");
        entryTotalCancelled = getTotalEmittedByEntryAndStatus(cancelledBondStatus.getId());
        //log.info("-------------------------6.------------------");
        if (entry == null) {
            taxesCancelled = getAllReversedTaxesTotalsByStatus(cancelledBondStatus.getId());
        } else {
        ...
        totalReversed = BigDecimal.ZERO;
        entryTotalReversed = getTotalEmittedByEntryAndStatus(reversedMunicipalBondStatus.getId());
        //log.info("-------------------------10.------------------");
        if (entry == null) {
            taxesReversed = getAllReversedTaxesTotalsByStatus(reversedMunicipalBondStatus.getId());
        } else {
     ...
     * @return
     */
    private List<EntryTotalCollected> getAllReversedTaxesTotalsByStatus(Long statusId) {
        statusIds = new ArrayList<Long>();
        statusIds.add(statusId);
        Query query = query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalReversedBetweenDatesByTaxItem");
        query.setParameter("municipalBondStatusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        return query.getResultList();
    ...
    public void loadReversedStatus() {
        ...
        cancelledBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_VOID");
    }

    private List<EntryTotalCollected> getAllEmissionTotalsCurrentPeriod() {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalEmittedBetweenDatesCurrentPeriodByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
    ...
    private List<EntryTotalCollected> getAllEmissionTotalsPreviousPeriods() {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalEmittedBetweenDatesPreviousPeriodsByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
    ...
    private List<EntryTotalCollected> getAllEmissionTaxesTotalsPreviousPeriods() {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalTaxesEmittedByPreviousPeriodsBetweenDatesByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
    ...
    private List<EntryTotalCollected> getAllEmissionTaxesTotalsCurrentPeriod() {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalTaxesEmittedByPeriodBetweenDatesByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
    ...
    private List<EntryTotalCollected> getAllReversedTotals(Long statusId) {
        statusIds = new ArrayList<Long>();
        statusIds.add(statusId);
        Query query = query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalReversedBetweenDatesByItem");
        query.setParameter("municipalBondStatusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        return query.getResultList();
    ...
    private List<EntryTotalCollected> getAllEmissionTotalsCurrentPeriod(Long entryId) {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalEmittedByEntryBetweenDatesAndCurrrentPeriodByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
    ...
    private List<EntryTotalCollected> getAllEmissionTotalsPreviousPeriods(Long entryId) {
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalEmittedByEntryBetweenDatesAndPreviousPeriodsByItem");
        query.setParameter("statusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("emisionPeriod", userSession.getFiscalPeriod().getStartDate());
    ...
    private List<EntryTotalCollected> getAllReversedByEntry(Entry e, Long statusId) {
        statusIds = new ArrayList<Long>();
        statusIds.add(statusId);
        Query query = getEntityManager().createNamedQuery("MunicipalBond.SumTotalReversedByEntryBetweenDatesByItem");
        query.setParameter("municipalBondStatusIds", statusIds);
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("entryId", e.getId());
    ...
    private List<EntryTotalCollected> getTotalEmittedByEntryAndStatus(Long statusId) {
    ...
    private void addNodes(TreeNode<AccountBalance> node, Long id, TreeNode<AccountBalance> child) {
    ...
    private boolean existsInAccountBalance(List<AccountBalance> list, AccountBalance ab) {
        for (AccountBalance a : list) {
            if (a.getAccount() != null && ab.getAccount() != null
                    && a.getAccount().getAccountCode().equals(ab.getAccount().getAccountCode())) {
                return true;
            }
        }
        return false;
    ...
    private void buildTree(TreeNode<AccountBalance> _rootNode) {
        ...
        for (AccountBalance oe : a.getChildren()) {
            ...
            if (!globalReport && oe.getAccount() != null && oe.getAccount().getIsShowSummary()) {
            ...
            if (globalReport && oe.getAccount() != null && oe.getAccount().getShowSubtotal()) {
                buildTotalBalance(oe);
                if (oe.getTotal().compareTo(BigDecimal.ZERO) == 1) {
                    if (!existsInAccountBalance(accountsForSummary, oe)) {
                        accountsForSummary.add(oe);
        ...
        if (ac.getAccount().getId() != null) {
            ...
            if (entryTotalCollecteds != null) {
                for (EntryTotalCollected ec : entryTotalCollecteds) {
                    if (ec.getAccount() != null && isAChildAccount(ec.getAccount(), ac.getAccount())) {
                        total = total.add(ec.getTotal());
                        value = value.add(ec.getValue());
                        if (ec.getPreviousYears() != null) {
                            previousYears = previousYears.add(ec.getPreviousYears());
                        }
                    }
                }
            }
    ...
    private List<MunicipalBond> findMunicipalBondFromDeposits(List<Deposit> deposits) {
    ...
    private List<Long> findChildren(Long id) {
        Query query = getEntityManager().createNativeQuery("WITH RECURSIVE recursetree(id, parent_id) AS ("
    ...
    public List<Account> findAccountsByItemDeposits() {
        ...
        if (paidMunicipalBondStatus == null) {
            paidMunicipalBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_PAID");
        }

        Query query = getEntityManager().createNamedQuery("MunicipalBond.findAccountsByDepositsAndItem");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("municipalBondStatusId", paidMunicipalBondStatus.getId());
    ...
    public List<Account> findAccountsBySurchargeItemDeposits() {
        ...
        Query query = getEntityManager().createNamedQuery("MunicipalBond.findAccountsByDepositsAndSurchargeItem");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("municipalBondStatusId", paidMunicipalBondStatus.getId());
        accounts = query.getResultList();
    ...
    public List<Account> findAccountsByDiscountItemDeposits() {
        List<Account> accounts = new ArrayList<Account>();
        Query query = getEntityManager().createNamedQuery("MunicipalBond.findAccountsByDepositsAndDiscountItem");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("municipalBondStatusId", paidMunicipalBondStatus.getId());
        accounts = query.getResultList();
    ...
    public List<Account> findAccountsByTaxItemDeposits() {
        List<Account> accounts = new ArrayList<Account>();
        Query query = getEntityManager().createNamedQuery("MunicipalBond.findAccountsByDepositsAndTaxItem");
        query.setParameter("startDate", startDate);
        query.setParameter("endDate", endDate);
        query.setParameter("municipalBondStatusId", paidMunicipalBondStatus.getId());
        return query.getResultList();
    ...
    public List<Deposit> getDepositsFromPayments(List<Payment> payments) {
        ...
        if (paymentsIds.size() > 0) {
            Query query = getEntityManager().createNamedQuery("Deposit.findDepositsFromPayments");
    ...
    private void loadInterestAccount() {
        ...
        interestAccount = systemParameterService.materialize(Account.class, "INTEREST_ACCOUNT_ID");
        interestAccountEmaalep = systemParameterService.materialize(Account.class, "INTEREST_ACCOUNT_ID_EMAALEP");
    }
    ...
    public void setBlockedMunicipalBondStatus(MunicipalBondStatus blockedMunicipalBondStatus) {
    ...
    private void loadMunicipalBondStatus() {
        ...
        pendingStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_PENDING");
        paidMunicipalBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_PAID");
        compensationMunicipalBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_COMPENSATION");
        inPaymentAgreementStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_IN_PAYMENT_AGREEMENT");
        externalChannelStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_PAID_FROM_EXTERNAL_CHANNEL");
        blockedMunicipalBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_BLOCKED");
        reversedMunicipalBondStatus = systemParameterService.materialize(MunicipalBondStatus.class, "MUNICIPAL_BOND_STATUS_ID_REVERSED");
    }
    ...
    public PaymentFraction createPaymentFraction(PaymentFraction p, BigDecimal value) {
    ...
    public List<PaymentFraction> orderPaymentsFractionForResident(
        ...
        for (PaymentFraction pf : list) {
            names.add(pf.getPayment().getDeposits().get(0).getMunicipalBond().getResident().getName());
        }
        Collections.sort(names);
        for (String n : names) {
            for (PaymentFraction pf : list) {
                if (pf.getPayment().getDeposits().get(0).getMunicipalBond()
                        .getResident().getName().equals(n) && !res.contains(pf)) {
                    res.add(pf);
                }
            }
        }
    ...
    public List<Payment> getPaymentsByBranchAndDate(Long branchId, Date d) {
        ...
        Long municipalBondStatusId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_COMPENSATION");
        Query query = getEntityManager().createNamedQuery("Payment.findByBranchAndDate");
    ...
    public void mergeEmissions(List<ReportView> emitted, List<ReportView> nullified) {
        ...
        for (ReportView rv : emitted) {
            for (ReportView rv1 : nullified) {
                if (rv.getPersonId().equals(rv1.getPersonId())) {
                    ...
                    rv.setTotal(rv.getTotalEmitted().subtract(rv.getTotalValueReversed()));
                }
            }
        }
    }
    ...
    public void generateEmittersReport() {
        ...
        try {
            municipalBondItems = MunicipalBondUtil.fillMunicipalBondItems(municipalBonds);
        } catch (Exception e) {
    ...
    public List<ReportView> getTotalTransactionsBetweenDates() {
        ...
        if (person == null) {
            ...
            totalReversed = getTotalReversedTransactionsBetweenDates(person.getId());
        }
    ...
    private List<ReportView> findMissing(List<ReportView> correct, List<ReportView> reversed) {
    ...
    public List<ReportView> getTotalReversedTransactionsBetweenDates(Long cashierId) {
        String namedQuery = "";
        if (cashierId == null) {
    ...
    private List<EntryTotalCollected> findTotalCreditNoteBetweenDatesByCreditNoteType(Date start, Date end) {
    ...
    public List<EntryTotalCollected> getSummaryTotalCollected() {
        ...
        String message = Interpolator.instance().interpolate("#{messages['workday.cashCollected']}", new Object[0]);
        entryTotalCollected.setGroupBy(message);
        entryTotalCollected.setTotal(sumTotalCashCollected());

        List<EntryTotalCollected> creditNoteList = findTotalCreditNoteBetweenDatesByCreditNoteType(startDate, endDate);
        totalCollecteds.addAll(creditNoteList);

        entryTotalCollected.setTotal(entryTotalCollected.getTotal().subtract(findTotal(creditNoteList)));

        totalCollecteds.add(0, entryTotalCollected);

        if (globalReport) {
            EntryTotalCollected entryTotalCollected4 = new EntryTotalCollected();
            message = Interpolator.instance().interpolate("#{messages['item.totalDiscountCollected']}", new Object[0]);
            entryTotalCollected4.setGroupBy(message);
            entryTotalCollected4.setTotal(discountsValueEffective.multiply(new BigDecimal(-1)));
            totalCollecteds.add(entryTotalCollected4);
        }

        EntryTotalCollected entryTotalCollected1 = new EntryTotalCollected();
        message = Interpolator.instance().interpolate("#{messages['workday.inPaymentAgreement']}", new Object[0]);
        ...
        message = Interpolator.instance().interpolate("#{messages['workday.pendingPaid']}", new Object[0]);
        ...
        if (globalReport) {
            ...
            message = Interpolator.instance().interpolate("#{messages['item.totalDiscountCollectedCompensation']}", new Object[0]);
            entryTotalCollected5.setGroupBy(message);
            entryTotalCollected5.setTotal(discountsValueByCompensation.multiply(new BigDecimal(-1)));
    ...
    public List<EntryTotalCollected> getTotals(boolean isPaidCompensation) {
        ...
        if (isPaidCompensation) {
            municipalBondId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_COMPENSATION");
        } else {
            municipalBondId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_PAID");
        }
    ...
    private List<EntryTotalCollected> getTotalsByItems(Long municipalBondStatusId) {

        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id, e.name," + groupBy + ", SUM(i.total)) "
    ...
    private List<EntryTotalCollected> getTotalsDiscountByItems(Long municipalBondStatusId) {
    ...
    private List<EntryTotalCollected> getTotalsTaxByItems(Long municipalBondStatusId) {
    ...
    private List<EntryTotalCollected> getTotalsSurchargeByItems(Long municipalBondStatusId) {
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id, e.name," + groupBy + ", SUM(i.total)) "
    ...
    private void deleteEmptyEntryTotalCollected(List<EntryTotalCollected> list) {
        ...
        for (EntryTotalCollected e : list) {
            if (e.getTotal() == null || e.getTotal().compareTo(BigDecimal.ZERO) == 0) {
                remove.add(e);
            }
        }
    ...
    @SuppressWarnings("unchecked")
    private List<EntryTotalCollected> getTotalsInterestByItems(Long municipalBondStatusId) {
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(SUM(m.interest)) "
                + "from MunicipalBond m join m.entry e left join e.account ac where m.id in "
    ...
    public List<EntryTotalCollected> getTotalsByItem(boolean isPaidCompensation) {
        ...
        if (isPaidCompensation) {
            municipalBondStatusId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_COMPENSATION");
        } else {
            municipalBondStatusId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_PAID");
        }
    ...
    public List<EntryTotalCollected> getTotalDepositsInAgreement() {
        ...
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id,count(d.id), e.name," + groupBy + ", SUM(d.value), "
    ...
    public List<EntryTotalCollected> getTotalsInPaymentAgreementByItem(boolean isPaidByCompensation) {
        List<EntryTotalCollected> result;
        if (systemParameterService == null) {
            systemParameterService = ServiceLocator.getInstance().findResource(SYSTEM_PARAMETER_SERVICE_NAME);
        }
        Long municipalBondStatusId = systemParameterService.findParameter("MUNICIPAL_BOND_STATUS_ID_IN_PAYMENT_AGREEMENT");
    ...
    public List<EntryTotalCollected> getTotalsInPaymentAgreement(boolean isPaidByCompensation, List<Long> ids) {
        ...
        String sql = "select NEW ec.gob.gim.income.model.EntryTotalCollected(e.id,count(id), e.name," + groupBy + ", SUM(d.value), SUM(m.discount), SUM(m.surcharge), "
    ...
    public List<EntryTotalCollected> getTotalCompensationCollectedByEntry() {
        ...
        for (EntryTotalCollected res : totalCollecteds) {
            if (res.getTotal() != null && res.getTotal().compareTo(BigDecimal.ZERO) == 0) {
    ...
    public List<EntryTotalCollected> getTotalCollectedByEntry(boolean isPaidByCompensation) {
...
//                if (getNumberOfTillOpened(getWorkdayId()) > 0) {
//                    existOpenedTills = true;
//                    return;
//                }
                startDate = new Date();
...
//        return super.find(); 
//        }catch(IllegalStateException ex ){
        Query query = getPersistenceContext().createNamedQuery("Workday.findById");
        query.setParameter("id", this.getId());
        Workday openedWorkday = (Workday) query.getSingleResult();
        return openedWorkday;
//        }
    }
    ...
    public Long findWorkdayId() {
        Query query = getPersistenceContext().createNamedQuery("Workday.findCurrentWorkday");
        List<Workday> list = query.getResultList();
        Long c = null;
    ...
    public BigDecimal getTotalValue(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getValue() != null) {
                res = res.add(e.getValue());
    ...
    public BigDecimal getTotalValuePreviousYears(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getPreviousYears() != null) {
                res = res.add(e.getPreviousYears());
    ...
    public BigDecimal getTotalValueNextYears(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getNextYears() != null) {
                res = res.add(e.getNextYears());
    ...
    public BigDecimal getTotalDiscounts(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            if (e.getDiscount() != null) {
                res = res.add(e.getDiscount());
    ...
    public BigDecimal getTotalSurcharges(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            res = res.add(e.getSurcharge());
        }
    ...
    public BigDecimal getTotalInterests(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            res = res.add(e.getInterest());
        }
    ...
    public BigDecimal getTotalTaxes(List<EntryTotalCollected> entryTotalCollecteds) {
        BigDecimal res = BigDecimal.ZERO;
        for (EntryTotalCollected e : entryTotalCollecteds) {
            res = res.add(e.getTaxes());
        }
        ...
        for (AccountBalance ab : ac.getChildren()) {
            ...
            if (isFromIncome) {
                ...
                if (ab.getPreviousYears() != null) {
                    ac.setPreviousYears(ac.getPreviousYears().add(ab.getPreviousYears()));
                }
                if (ab.getValue() != null) {
    ...
    public AccountBalance copyAccountBalance(AccountBalance a) {
        ...
        ab.setDiscount(a.getDiscount() == null ? BigDecimal.ZERO : a.getDiscount());
        ab.setInterest(a.getInterest() == null ? BigDecimal.ZERO : a.getInterest());
        ab.setParent(a.getParent());
        ab.setSurcharge(a.getSurcharge() == null ? BigDecimal.ZERO : a.getSurcharge());
        ...
        ab.setPreviousYears(a.getPreviousYears() == null ? BigDecimal.ZERO : a.getPreviousYears());
        ab.setNextYears(a.getNextYears() == null ? BigDecimal.ZERO : a.getNextYears());
    ...
    public void buildMainAccounts() {
        ...
        for (AccountBalance c : mainAccountBalance.getChildren()) {
            ...
            if (ab.getTotal() != null && ab.getTotal().compareTo(BigDecimal.ZERO) > 0) {
                mainAccounts.add(ab);
            }
        }
    ...
    public List<AccountBalance> orderAccountBalanceByAccountCode(List<AccountBalance> list) {
    ...
    public List<AccountBalance> classificationBuildMainAccounts() {
        ...
        for (int i = 0; i < finallyAccountsForSummary.size(); i++) {
            for (int j = i + 1; j < finallyAccountsForSummary.size(); j++) {
                if (isAChild(finallyAccountsForSummary.get(j).getAccount(), finallyAccountsForSummary.get(i).getAccount())) {
    ...
    public void openTillsBank() {
        ...
        for (TillPermission tp : this.getInstance().getTillPermissions()) {
//			if ((tp.getTill().isTillBank()) && (tp.getOpeningTime() == null)){
...
//			}			
    ...
    public String save() throws ExistsDuplicateUsers  {
        if (existsDuplicateUsers()) {
            throw new ExistsDuplicateUsers();
...
//            return "failed";
        ...
        if (!needsTaxRateDefined && existsCurrentWorkday == null && !existOpenedTills) {
            if (isManaged()) {
                return update();
            } else {
                new File("/opt/jboss/6.1.0.Final/server/instance01/deploy/gim.ear/gim.war/PDFDocuments/*").delete();
                new File("/opt/jboss/6.1.0.Final/server/instance02/deploy/gim.ear/gim.war/PDFDocuments/*").delete();
                new File("/opt/jboss/6.1.0.Final/server/instance03/deploy/gim.ear/gim.war/PDFDocuments/*").delete();
                return persist();
            }
        }

        if (isManaged() && !needsTaxRateDefined && existsCurrentWorkday && !isReadyForPrint) {
...
//            raiseAfterTransactionSuccessEvent();
        ...
        em = getEntityManager();
        Query query = null;
        query = em.createNamedQuery("Workday.changeStatus");
        query.setParameter("closingworkdaydate", this.getInstance().getClosingWorkdayDate());
        query.setParameter("isincomeopening", this.getInstance().getIsIncomeOpening());
        query.setParameter("closingtime", this.getInstance().getClosingTime());
        query.setParameter("incomeobservations", this.getInstance().getIncomeObservations() == null ? "" : this.getInstance().getIncomeObservations());
...
//			}
            ...
            if (!isDateAvailable(this.getInstance().getDate()) || (this.getInstance().getDate().before(current.getTime()))) {
                String message = Interpolator.instance().interpolate("#{messages['workday.dateNoAvailable']}", new Object[0]);
                facesMessages.addToControl("",
                        org.jboss.seam.international.StatusMessage.Severity.ERROR,
                        message);
                return "failed";
            ...
            if (!isChargeAvailable()) {
                String message = Interpolator.instance().interpolate("#{messages['workday.chargeNoAvailable']}", new Object[0]);
                facesMessages.addToControl("",
                        org.jboss.seam.international.StatusMessage.Severity.ERROR,
                        message);
                return "failed";
...
//      assignId( getInstance().getId() );
        Query query = null;
        String sqlIdentitygeneratorId = "SELECT value\n"
                + "FROM IdentityGenerator ig\n"
                + "WHERE\n"
                + "ig.name = :name";
...
//			this.getInstance().setDate(now.getTime());
//			this.getInstance().setOpeningTime(now.getTime());
        String sqlWorkday1 = "INSERT INTO Workday(\n"
                + "id , charge, " +/*"closingWorkdayDate,"+*/ " date, incomeObservations, isIncomeOpening, \n"
                + /*"isRevenueOpening", revenueObservations,"+*/ "openingTime"/*",closingTime"*/ + ")\n"
                + " VALUES (:id ,:charge, " +/*":closingWorkdayDate,+"*/ " :date, :incomeObservations, :isIncomeOpening, "
                + /*":isRevenueOpening, :revenueObservations, "*/ ":openingTime" +/*", :closingTime"*/ ") \n";
//             String sqlWorkday2="UPDATE Workday w\n"+
//                              "SET\n" +
//                              "charge=:charge, "+/*"closingWorkdayDate,"+*/" date=:date, "+/*"incomeObservations, isIncomeOpening, \n" +
//                              "isRevenueOpening, revenueObservations,"+*/"openingTime=:openingTime"/*+",closingTime"*/+"\n" +
//                              " WHERE id IN (:id)" ; 
        String sqlTillpermission = "INSERT INTO TillPermission(\n"
                + "id"/*, closingTime, initialBalance*/ + ", isEnabled"/*, observation, openingTime*/ + ", \n"
                + "person_id, till_id, workday_id)\n"
                + "VALUES (:id "/*, :closingTime, :initialBalance*/ + ", :isEnabled"/*, :observation, :openingTime*/ + ", \n"
                + ":person, :till, :workday) \n";
        String sqlIdentityGeneratorU = "UPDATE IdentityGenerator ws\n"
                + "  SET"
                + "  value = :value   \n"
                + "  WHERE ws.name IN (:name)";

        try {
//                em.getTransaction().begin();
            query = em.createNativeQuery(sqlIdentitygeneratorId);
            query.setParameter("name", "Workday");
            int wdId =  Integer.parseInt(query.getSingleResult().toString());
            query = em.createNativeQuery(sqlIdentitygeneratorId);
            query.setParameter("name", "TillPermission");
            int tpId =   Integer.parseInt(query.getSingleResult().toString());
            getInstance().setId(Long.valueOf(wdId));
            query = em.createNativeQuery(sqlWorkday1);
            query.setParameter("id", wdId);
            query.setParameter("charge", getInstance().getCharge());
//                query.setParameter("closingWorkdayDate", getInstance().getClosingWorkdayDate());
            query.setParameter("date", getInstance().getDate());
            query.setParameter("incomeObservations", getInstance().getIncomeObservations() == null ? "" : getInstance().getIncomeObservations());
            query.setParameter("isIncomeOpening", getInstance().getIsIncomeOpening());
//                query.setParameter("isRevenueOpening", getInstance().getIsRevenueOpening());
//                query.setParameter("revenueObservations", getInstance().getRevenueObservations());
            query.setParameter("openingTime", getInstance().getOpeningTime());
//                query.setParameter("closingTime" , getInstance().getClosingTime());     
            int wR1 = query.executeUpdate();
            em.flush();
//                em.getTransaction().commit();
//                query =em.createNativeQuery(sqlWorkday2);
//                query.setParameter("id", wdId);
//                query.setParameter("charge", getInstance().getCharge());
//                query.setParameter("closingWorkdayDate", getInstance().getClosingWorkdayDate());
//                query.setParameter("date", getInstance().getDate());
//                query.setParameter("incomeObservations", getInstance().getIncomeObservations());
//                query.setParameter("isIncomeOpening", getInstance().getIsIncomeOpening());
//                query.setParameter("isRevenueOpening", getInstance().getIsRevenueOpening());
//                query.setParameter("revenueObservations", getInstance().getRevenueObservations());
//                query.setParameter("openingTime" , getInstance().getOpeningTime());      
//                query.setParameter("closingTime" , getInstance().getClosingTime());     
//                int wR2= query.executeUpdate();
            assignId(getInstance().getId());

            for (TillPermission tpl : getInstance().getTillPermissions()) {
                query = em.createNativeQuery(sqlTillpermission);
                query.setParameter("id", tpId);

//                    query.setParameter("closingTime", tpl.getClosingTime());
//                    query.setParameter("initialBalance", tpl.getInitialBalance());
                query.setParameter("isEnabled", tpl.isEnabled());
//                    query.setParameter("observation", tpl.getObservation());
//                    query.setParameter("openingTime", tpl.getOpeningTime());
                query.setParameter("person", tpl.getPerson().getId());
                query.setParameter("till", tpl.getTill().getId());
                query.setParameter("workday", getInstance().getId());
                int tpR = query.executeUpdate();
                em.flush();
                tpId++;
            }
            query = em.createNativeQuery(sqlIdentityGeneratorU);
            query.setParameter("name", "Workday");
            query.setParameter("value", ++wdId);
            int wRId = query.executeUpdate();
            query = em.createNativeQuery(sqlIdentityGeneratorU);
            query.setParameter("name", "TillPermission");
            query.setParameter("value", tpId);
            int tpRId = query.executeUpdate();
...
//            }
    ...
    public boolean isDateAvailable(Date d) {
        Query query = null;
        if (isFromIncome) {
            query = getPersistenceContext().createNamedQuery("Workday.findByIncomeOpeningAndDate").setParameter("date", d);
        } else {
            query = getPersistenceContext().createNamedQuery("Workday.findByRevenueOpeningAndDate").setParameter("date", d);
        }

        List<Workday> workdays = query.getResultList();
        if (workdays != null && workdays.size() > 0 && workdays.get(0).getId() != this.getInstance().getId()) {
            return false;
        }
        return true;
    }
    ...
    public boolean existOpenedWorkdays() {
        Query query = getPersistenceContext().createNamedQuery("Workday.countOpenedWorkday");
    ...
    public boolean isChargeAvailable() {
        Query query = getPersistenceContext().createNamedQuery("Workday.findByCharge")
                .setParameter("charge", this.getInstance().getCharge());
        List<Workday> workdays = query.getResultList();
        if (workdays != null && workdays.size() > 0
    ...
    public void setEntryTotalCollecteds(List<EntryTotalCollected> entryTotalCollecteds) {
    ...
    public void setEntryTotalCollectedsByCompensation(List<EntryTotalCollected> entryTotalCollectedsByCompensation) {
    ...
    public void setSummaryTotalCollecteds(List<EntryTotalCollected> summaryTotalCollecteds) {
    ...
    public void setEntryTotalDiscount(List<EntryTotalCollected> entryTotalDiscount) {
    ...
    public void setEntryTotalReversed(List<EntryTotalCollected> entryTotalReversed) {
    ...
    public void setEntryTotalCancelled(List<EntryTotalCollected> entryTotalCancelled) {
        this.entryTotalCancelled = entryTotalCancelled;
    }

    public void setEntryTotalCollectedsInAgreement(List<EntryTotalCollected> entryTotalCollectedsInAgreement) {
    ...
    public void setInterestValueCompensation(BigDecimal interestValueCompensation) {
    ...
    public void setPreviousValueCompensation(BigDecimal previousValueCompensation) {
