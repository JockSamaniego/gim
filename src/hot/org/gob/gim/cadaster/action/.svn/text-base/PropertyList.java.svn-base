...
public class PropertyList extends EntityQuery<Property> {
	...
	private static final String[] RESTRICTIONS = {
			"(lower(resident.identificationNumber) like lower(concat(#{propertyList.residentCriteria},'%')) or " +
	...
	public void chargePropertyType(){
		...
		isFirstTime = false;
		String name="PROPERTY_TYPE_ID_RUSTIC";
		if(isUrban) name ="PROPERTY_TYPE_ID_URBAN";
