...
//		pair = new ValuePair("Clave anterior",previousCadastralCode);
		...
		pair = new ValuePair("Avalúo terreno", lotAppraisal != null ? lotAppraisal.toString() : "");
		details.add(pair);
		pair = new ValuePair("Avalúo construcci\u00F3n",buildingAppraisal != null ? buildingAppraisal.toString() : "");
		details.add(pair);
		...
		if (improvementAppraisal != null && improvementAppraisal.intValue() > 0) {
			pair = new ValuePair("Avalúo mejoras", improvementAppraisal != null ? improvementAppraisal.toString() : "");
			details.add(pair);
		}
		
		pair = new ValuePair("Avalúo comercial",commercialAppraisal != null ? commercialAppraisal.toString() : "");
		details.add(pair);
