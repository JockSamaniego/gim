...
/**
 * Bitácora Digital: Inventario del vehículo retenido
 * 
...
@Audited
@Entity
@TableGenerator(name = "VehicleInventoryGenerator", table = "IdentityGenerator", pkColumnName = "name", valueColumnName = "value", pkColumnValue = "VehicleInventory", initialValue = 1, allocationSize = 1)
public class VehicleInventory implements Serializable {

	private static final long serialVersionUID = -3934384803572025182L;

	@Id
	@GeneratedValue(generator = "VehicleInventoryGenerator", strategy = GenerationType.TABLE)
	private Long id; 
    
	@Column(length = 40)
	private String name; //Nombres
	private Boolean value; //Valor si está en el inventario
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VehicleInventory other = (VehicleInventory) obj;
		if (active == null) {
	...
	public String toString() {
		return "VehicleInventory [id=" + id + ", name=" + name + ", value=" + value + ", amount=" + amount + ", active="
				+ active + "]";
	}
